...
// Supabase query builder type is complex; use `any` locally (in the `let q:
// any = ...` query-building blocks below) to avoid fighting the chain-style
// return types from the SDK.
